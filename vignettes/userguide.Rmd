...
```{r}
mock.output <- tempfile()
dir.create(mock.output)
...
custom.config <- newConfig(
    fetch.file=function(x) file.path(mock.output, x),
    fetch.gene=function(x) file.path(mock.output, x),
    fetch.ranges=function(n, s, e) readDatabaseRanges(mock.output, n, s, e) 
)
```
